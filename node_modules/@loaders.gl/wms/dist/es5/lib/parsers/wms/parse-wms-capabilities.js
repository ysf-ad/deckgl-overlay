...
function parseWMSCapabilities(xmlText, options) {
  const parsedXML = _xml.XMLLoader.parseTextSync(xmlText, options);
...
function extractCapabilities(xml) {
  ...
  const xmlLayers = (0, _parseXmlHelpers.getXMLArray)((_xml$Capability2 = xml.Capability) === null || _xml$Capability2 === void 0 ? void 0 : _xml$Capability2.Layer);
...
function extractRequests(xmlRequests) {
  ...
  for (const [name, xmlRequest] of Object.entries(xmlRequests || {})) {
    const mimeTypes = (0, _parseXmlHelpers.getXMLStringArray)(xmlRequest === null || xmlRequest === void 0 ? void 0 : xmlRequest.Format);
    requests[name] = {
      mimeTypes
    };
  }
...
function extractExceptions(xmlException) {
  const xmlExceptionFormats = (0, _parseXmlHelpers.getXMLArray)(xmlException === null || xmlException === void 0 ? void 0 : xmlException.Format);
...
function extractLayer(xmlLayer) {
  ...
  const xmlDimensions = (0, _parseXmlHelpers.getXMLArray)(xmlLayer === null || xmlLayer === void 0 ? void 0 : xmlLayer.Dimension);
  ...
  const xmlLayers = (0, _parseXmlHelpers.getXMLArray)(xmlLayer === null || xmlLayer === void 0 ? void 0 : xmlLayer.Layer);
  const layers = [];
  for (const xmlSubLayer of xmlLayers) {
...
function extractWMSBoundingBoxes(xmlBoundingBoxes) {
  const xmlBoxes = (0, _parseXmlHelpers.getXMLArray)(xmlBoundingBoxes);
