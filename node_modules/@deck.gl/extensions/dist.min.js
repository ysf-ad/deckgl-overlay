...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var o=!0,a=!1,f;return{s:function(){e=e.call(t)},n:function(){var l=e.next();return o=l.done,l},e:function(l){a=!0,f=l},f:function(){try{!o&&e.return!=null&&e.return()}finally{if(a)throw f}}}}function En(t,r){if(t){if(typeof t=="string")return Ct(t,r);var e=Object.prototype.toString.call(t).slice(8,-1);if(e==="Object"&&t.constructor&&(e=t.constructor.name),e==="Map"||e==="Set")return Array.from(t);if(e==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e))return Ct(t,r)}}function Ct(t,r){(r==null||r>t.length)&&(r=t.length);for(var e=0,n=new Array(r);e<r;e++)n[e]=t[e];return n}var de=function(){function t(){y(this,t),u(this,"id","mask-effect"),u(this,"props",null),u(this,"useInPicking",!0),u(this,"order",0),u(this,"dummyMaskMap",void 0),u(this,"channels",[]),u(this,"masks",null),u(this,"maskPass",void 0),u(this,"maskMap",void 0),u(this,"lastViewport",void 0)}return g(t,[{key:"preRender",value:function(e,n){var i=n.layers,o=n.layerFilter,a=n.viewports,f=n.onViewportActive,s=n.views,l=n.isPicking,c=!1;if(this.dummyMaskMap||(this.dummyMaskMap=new It.Texture2D(e,{width:1,height:1})),l)return{didRender:c};var p=i.filter(function(T){return T.props.visible&&T.props.operation.includes("mask")});if(p.length===0)return this.masks=null,this.channels.length=0,{didRender:c};this.masks={},this.maskPass||(this.maskPass=new Ft(e,{id:"default-mask"}),this.maskMap=this.maskPass.maskMap);var v=this._sortMaskChannels(p),_=a[0],m=!this.lastViewport||!this.lastViewport.equals(_);if(_.resolution!==void 0)return Ie.log.warn("MaskExtension is not supported in GlobeView")(),{didRender:c};for(var P in v){var O=this._renderChannel(v[P],{layerFilter:o,onViewportActive:f,views:s,viewport:_,viewportChanged:m});c||(c=O)}return{didRender:c}}},{key:"_renderChannel",value:function(e,n){var i=n.layerFilter,o=n.onViewportActive,a=n.views,f=n.viewport,s=n.viewportChanged,l=!1,c=this.channels[e.index];if(!c)return l;var p=e===c||e.layers.length!==c.layers.length||e.layers.some(function(O,T){return O!==c.layers[T]||O.props.transitions})||e.layerBounds.some(function(O,T){return O!==c.layerBounds[T]});if(e.bounds=c.bounds,e.maskBounds=c.maskBounds,this.channels[e.index]=e,p||s){this.lastViewport=f;var v=j(e.layers,f);if(e.bounds=v&&z(v,f),p||!B(e.bounds,c.bounds)){var _=this.maskPass,m=this.maskMap,P=v&&V({bounds:e.bounds,viewport:f,width:m.width,height:m.height,border:1});e.maskBounds=P?P.getBounds():[0,0,1,1],_.render({pass:"mask",channel:e.index,layers:e.layers,layerFilter:i,viewports:P?[P]:[],onViewportActive:o,views:a,moduleParameters:{devicePixelRatio:1}}),l=!0}}return this.masks[e.id]={index:e.index,bounds:e.maskBounds,coordinateOrigin:e.coordinateOrigin,coordinateSystem:e.coordinateSystem},l}},{key:"_sortMaskChannels",value:function(e){var n=this,i={},o=0,a=On(e),f;try{var s=function(){var P=f.value,O=P.root.id,T=i[O];if(!T){if(++o>4)return Ie.log.warn("Too many mask layers. The max supported is 4")(),"continue";T={id:O,index:n.channels.findIndex(function(w){return w?.id===O}),layers:[],layerBounds:[],coordinateOrigin:P.root.props.coordinateOrigin,coordinateSystem:P.root.props.coordinateSystem},i[O]=T}T.layers.push(P),T.layerBounds.push(P.getBounds())};for(a.s();!(f=a.n()).done;)var l=s()}catch(m){a.e(m)}finally{a.f()}for(var c=0;c<4;c++){var p=this.channels[c];(!p||!(p.id in i))&&(this.channels[c]=null)}for(var v in i){var _=i[v];_.index<0&&(_.index=this.channels.findIndex(function(m){return!m}),this.channels[_.index]=_)}return i}},{key:"getModuleParameters",value:function(){return{maskMap:this.masks?this.maskMap:this.dummyMaskMap,maskChannels:this.masks}}},{key:"cleanup",value:function(){this.dummyMaskMap&&(this.dummyMaskMap.delete(),this.dummyMaskMap=void 0),this.maskPass&&(this.maskPass.delete(),this.maskPass=void 0,this.maskMap=void 0),this.lastViewport=void 0,this.masks=null,this.channels.length=0}}]),t}();function Tn(t,r){var e=typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(!e){if(Array.isArray(t)||(e=wn(t))||r&&t&&typeof t.length=="number"){e&&(t=e);var n=0,i=function(){};return{s:i,n:function(){return n>=t.length?{done:!0}:{done:!1,value:t[n++]}},e:function(l){throw l},f:i}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var o=!0,a=!1,f;return{s:function(){e=e.call(t)},n:function(){var l=e.next();return o=l.done,l},e:function(l){a=!0,f=l},f:function(){try{!o&&e.return!=null&&e.return()}finally{if(a)throw f}}}}function wn(t,r){if(t){if(typeof t=="string")return Lt(t,r);var e=Object.prototype.toString.call(t).slice(8,-1);if(e==="Object"&&t.constructor&&(e=t.constructor.name),e==="Map"||e==="Set")return Array.from(t);if(e==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e))return Lt(t,r)}}function Lt(t,r){(r==null||r>t.length)&&(r=t.length);for(var e=0,n=new Array(r);e<r;e++)n[e]=t[e];return n}var Le=2,Bt=function(){function t(){y(this,t),u(this,"id","collision-filter-effect"),u(this,"props",null),u(this,"useInPicking",!0),u(this,"order",1),u(this,"channels",{}),u(this,"collisionFilterPass",void 0),u(this,"collisionFBOs",{}),u(this,"dummyCollisionMap",void 0),u(this,"lastViewport",void 0)}return g(t,[{key:"preRender",value:function(e,n){var i,o=n.effects,a=n.layers,f=n.layerFilter,s=n.viewports,l=n.onViewportActive,c=n.views,p=n.isPicking,v=n.preRenderStats,_=v===void 0?{}:v;if(this.dummyCollisionMap||(this.dummyCollisionMap=new F.Texture2D(e,{width:1,height:1})),!p){var m=a.filter(function(Oe){var De=Oe.props,cr=De.visible,pr=De.collisionEnabled;return cr&&pr});if(m.length===0){this.channels={};return}this.collisionFilterPass||(this.collisionFilterPass=new At(e,{id:"default-collision-filter"}));var P=o?.filter(function(Oe){return Oe.constructor===de}),O=(i=_["mask-effect"])===null||i===void 0?void 0:i.didRender,T=this._groupByCollisionGroup(e,m),w=s[0],ee=!this.lastViewport||!this.lastViewport.equals(w)||O;for(var G in T){var lr=this.collisionFBOs[G],ur=T[G];lr.resize({width:e.canvas.width/Le,height:e.canvas.height/Le}),this._render(ur,{effects:P,layerFilter:f,onViewportActive:l,views:c,viewport:w,viewportChanged:ee})}}}},{key:"_render",value:function(e,n){var i=n.effects,o=n.layerFilter,a=n.onViewportActive,f=n.views,s=n.viewport,l=n.viewportChanged,c=e.collisionGroup,p=this.channels[c];if(p){var v=l||e===p||!(0,Nt._deepEqual)(p.layers,e.layers,1)||e.layerBounds.some(function(m,P){return!B(m,p.layerBounds[P])})||e.allLayersLoaded!==p.allLayersLoaded||e.layers.some(function(m){return m.props.transitions});if(this.channels[c]=e,v){this.lastViewport=s;var _=this.collisionFBOs[c];this.collisionFilterPass.renderCollisionMap(_,{pass:"collision-filter",isPicking:!0,layers:e.layers,effects:i,layerFilter:o,viewports:s?[s]:[],onViewportActive:a,views:f,moduleParameters:{dummyCollisionMap:this.dummyCollisionMap,devicePixelRatio:(0,F.cssToDeviceRatio)(_.gl)/Le}})}}}},{key:"_groupByCollisionGroup",value:function(e,n){var i={},o=Tn(n),a;try{for(o.s();!(a=o.n()).done;){var f=a.value,s=f.props.collisionGroup,l=i[s];l||(l={collisionGroup:s,layers:[],layerBounds:[],allLayersLoaded:!0},i[s]=l),l.layers.push(f),l.layerBounds.push(f.getBounds()),f.isLoaded||(l.allLayersLoaded=!1)}}catch(O){o.e(O)}finally{o.f()}for(var c=0,p=Object.keys(i);c<p.length;c++){var v=p[c];this.collisionFBOs[v]||this.createFBO(e,v),this.channels[v]||(this.channels[v]=i[v])}for(var _=0,m=Object.keys(this.collisionFBOs);_<m.length;_++){var P=m[_];i[P]||this.destroyFBO(P)}return i}},{key:"getModuleParameters",value:function(e){var n=e.props.collisionGroup,i=this.collisionFBOs,o=this.dummyCollisionMap;return{collisionFBO:i[n],dummyCollisionMap:o}}},{key:"cleanup",value:function(){this.dummyCollisionMap&&(this.dummyCollisionMap.delete(),this.dummyCollisionMap=void 0),this.channels={};for(var e=0,n=Object.keys(this.collisionFBOs);e<n.length;e++){var i=n[e];this.destroyFBO(i)}this.collisionFBOs={},this.lastViewport=void 0}},{key:"createFBO",value:function(e,n){var i,o,a=e.canvas,f=a.width,s=a.height,l=new F.Texture2D(e,{width:f,height:s,parameters:(i={},u(i,10241,9728),u(i,10240,9728),u(i,10242,33071),u(i,10243,33071),i)}),c=new F.Renderbuffer(e,{format:33189,width:f,height:s});this.collisionFBOs[n]=new F.Framebuffer(e,{id:"Collision-".concat(n),width:f,height:s,attachments:(o={},u(o,36064,l),u(o,36096,c),o)})}},{key:"destroyFBO",value:function(e){for(var n=this.collisionFBOs[e],i=0,o=Object.values(n.attachments);i<o.length;i++){var a=o[i];a.delete()}n.delete(),delete this.collisionFBOs[e]}}]),t}();function An(t){var r=Mn();return function(){var n=d(t),i;if(r){var o=d(this).constructor;i=Reflect.construct(n,arguments,o)}else i=n.apply(this,arguments);return b(this,i)}}function Mn(){if(typeof Reflect>"u"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}var Rn={getCollisionPriority:{type:"accessor",value:0},collisionEnabled:!0,collisionGroup:{type:"string",value:"default"},collisionTestProps:{}},me=function(t){x(e,t);var r=An(e);function e(){return y(this,e),r.apply(this,arguments)}return g(e,[{key:"getShaders",value:function(){return{modules:[bt]}}},{key:"draw",value:function(i){var o=i.uniforms,a=i.context,f=i.moduleParameters,s=this.props.collisionEnabled,l=f.collisionFBO,c=f.drawToCollisionMap,p=s&&Boolean(l);o.collision_enabled=p,c&&(this.props=this.clone(this.props.collisionTestProps).props)}},{key:"initializeState",value:function(i,o){var a;if(this.getAttributeManager()!==null){(a=this.context.deck)===null||a===void 0||a._addDefaultEffect(new Bt);var f=this.getAttributeManager();f.add({collisionPriorities:{size:1,accessor:"getCollisionPriority",shaderAttributes:{collisionPriorities:{divisor:0},instanceCollisionPriorities:{divisor:1}}}})}}},{key:"getNeedsPickingBuffer",value:function(){return this.props.collisionEnabled}}]),e}(Dt.LayerExtension);u(me,"defaultProps",Rn);u(me,"extensionName","CollisionFilterExtension");var L=h(E());var jt=h(E()),Sn=`
